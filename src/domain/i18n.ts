...
const translations = {
  ...
  "backup.cloudSynced": { zhTW: "資料保留在這台裝置，並已同步至你的私人帳號。", en: "Your data stays on this device and is synced to your private account." },
  "backup.cloudSyncing": { zhTW: "資料保留在這台裝置，正在同步至你的私人帳號。", en: "Your data stays on this device and is syncing to your private account." },
  "backup.cloudError": { zhTW: "資料保留在這台裝置，雲端同步目前需要注意。", en: "Your data stays on this device. Cloud sync needs attention." },
  "schedule.sessionZh": { zhTW: "中文課程名稱", en: "Chinese session name" },
  "schedule.sessionEn": { zhTW: "英文課程名稱", en: "English session name" },
  "schedule.focusZh": { zhTW: "中文訓練重點", en: "Chinese training focus" },
  "schedule.focusEn": { zhTW: "英文訓練重點", en: "English training focus" },
